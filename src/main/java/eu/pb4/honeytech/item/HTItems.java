...
public class HTItems {
    ...
    public static Item TRASHCAN = new VirtualHeadBlockItem(HTBlocks.TRASHCAN, new Item.Settings());
    ...
    public static Item COAL_GENERATOR_MK1 = new VirtualHeadBlockItem(HTBlocks.COAL_GENERATOR_MK1, new Item.Settings());
    public static Item COAL_GENERATOR_MK2 = new VirtualHeadBlockItem(HTBlocks.COAL_GENERATOR_MK2, new Item.Settings());
    public static Item COAL_GENERATOR_MK3 = new VirtualHeadBlockItem(HTBlocks.COAL_GENERATOR_MK3, new Item.Settings());

    public static Item SMALL_BATTERY = new VirtualHeadBlockItem(HTBlocks.SMALL_BATTERY, new Item.Settings());
    public static Item MEDIUM_BATTERY = new VirtualHeadBlockItem(HTBlocks.MEDIUM_BATTERY, new Item.Settings());
    public static Item BIG_BATTERY = new VirtualHeadBlockItem(HTBlocks.BIG_BATTERY, new Item.Settings());
